...
int32 CheckTree(treeNode *t, uint32 *px, uint32 nv, uint32 nm, FILE *logFile);
...
int32 MultiWayBufferSnap(uint32 nv, uint32 nm, uint32 *multiChunkBuffer,
                         uint32 numberOfChunks, uint32 regSubChunkSize,
                         uint32 nRecords);
