...
from align.callsite_align import align, get_return_addresses, check_callsite_number
...
def test_different_callsite_number_pass():
    ...
    """
    input1 = get_return_addresses(TEST_INPUT_PATH + 'pass/objdump-arm.txt', 'aarch64')
    input2 = get_return_addresses(TEST_INPUT_PATH + 'pass/objdump-x86.txt', 'x86-64')
...
def test_different_callsite_number_fail():
    ...
    Test whether the function properly detects different number of callsites in the objdump files.
    """
    input1 = get_return_addresses(TEST_INPUT_PATH + 'fail/objdump-arm.txt', 'aarch64')
    input2 = get_return_addresses(TEST_INPUT_PATH + 'fail/objdump-x86.txt', 'x86-64')
