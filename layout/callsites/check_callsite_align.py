...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
        print('Usage: ./test_callsite_align<objdump_input_arm> <objdump_input_x86> ')
        sys.exit(1)

    ret_code = 0

    d1 = get_return_addresses(sys.argv[1], 'aarch64')
    d2 = get_return_addresses(sys.argv[2], 'x86-64')
