...
X86_64_MUSL	:= ~/musl_popcorn_toolchain/toolchain_x86-64
ARM64_MUSL  := ~/musl_popcorn_toolchain/toolchain_aarch64
...
$(ARM64_LOG): $(BIN)_opt.ll
	@echo " [LLC_DEBUG_PASS] $@"
	$(LLC) $(LLC_FLAGS) $(LLC_DEBUG) -march=aarch64 $< > $@ 2>&1
