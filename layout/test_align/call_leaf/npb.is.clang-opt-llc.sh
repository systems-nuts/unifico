...
/usr/local/popcorn/bin/aarch64-popcorn-linux-gnu-ld.bfd -o build_aarch64/call_leaf_aarch64 aarch64.llc.o -z noexecstack -z relro --hash-style=gnu --build-id -static -m aarch64linux -L/usr/local/popcorn/aarch64/lib -L/usr/lib/gcc-cross/aarch64-linux-gnu/9 /usr/local/popcorn/aarch64/lib/crt1.o /usr/local/popcorn/aarch64/lib/libc.a /usr/local/popcorn/aarch64/lib/libmigrate.a /usr/local/popcorn/aarch64/lib/libstack-transform.a /usr/local/popcorn/aarch64/lib/libelf.a /usr/local/popcorn/aarch64/lib/libpthread.a /usr/local/popcorn/aarch64/lib/libc.a /usr/local/popcorn/aarch64/lib/libm.a --start-group -lgcc -lgcc_eh --end-group -Map build_aarch64/map.txt
/usr/local/popcorn/bin/x86_64-popcorn-linux-gnu-ld.bfd -o build_x86-64/call_leaf_x86-64 x86_64.llc.o -z noexecstack -z relro --hash-style=gnu --build-id -static -m elf_x86_64 -L/usr/local/popcorn/x86_64/lib /usr/local/popcorn/x86_64/lib/crt1.o /usr/local/popcorn/x86_64/lib/libc.a /usr/local/popcorn/x86_64/lib/libmigrate.a /usr/local/popcorn/x86_64/lib/libstack-transform.a /usr/local/popcorn/x86_64/lib/libelf.a /usr/local/popcorn/x86_64/lib/libpthread.a /usr/local/popcorn/x86_64/lib/libc.a /usr/local/popcorn/x86_64/lib/libm.a --start-group --end-group -Map build_x86-64/map.txt
...
# link (aligned)
/usr/local/popcorn/bin/aarch64-popcorn-linux-gnu-ld.bfd -o call_leaf_aarch64 aarch64.llc.o -z noexecstack -z relro --hash-style=gnu --build-id -static -m aarch64linux -L/usr/local/popcorn/aarch64/lib -L/usr/lib/gcc-cross/aarch64-linux-gnu/9 /usr/local/popcorn/aarch64/lib/crt1.o /usr/local/popcorn/aarch64/lib/libc.a /usr/local/popcorn/aarch64/lib/libmigrate.a /usr/local/popcorn/aarch64/lib/libstack-transform.a /usr/local/popcorn/aarch64/lib/libelf.a /usr/local/popcorn/aarch64/lib/libpthread.a /usr/local/popcorn/aarch64/lib/libc.a /usr/local/popcorn/aarch64/lib/libm.a --start-group -lgcc -lgcc_eh --end-group -Map build_aarch64/aligned_map.txt -T build_aarch64/aligned_linker_script_arm.x
