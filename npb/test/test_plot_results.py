...
COLUMNS = ['Experiment', 'Flag', 'Benchmark', 'Architecture', 'Class', 'Iteration', 'Time']
...
def test_df_from_dir_correct():
    ...
    pd.testing.assert_frame_equal(target_df, df, check_like=True, check_less_precise=2, check_dtype=False), \
...
def test_get_overhead_df():
    ...
    """
    df = get_overhead_df('npb/test/results/correct', 'npb/test/results/correct2')
