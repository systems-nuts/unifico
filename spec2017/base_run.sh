...
do
  ...
  git checkout "$short_hash" -- spec2017/config/clang_base.cfg spec2017/config/info.json
...
git checkout development -- spec2017/config/clang_base.cfg spec2017/config/info.json
