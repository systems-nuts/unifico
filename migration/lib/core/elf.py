...
ELFMAG0 = (
    0x7F  # #define ELFMAG0         0x7f            /* Magic number byte 0 */
)
...
EI_CLASS = (
    4  # #define EI_CLASS        4               /* File class byte index */
)

EI_DATA = (
    5  # #define EI_DATA         5               /* Data encoding byte index */
)

EI_VERSION = (
    6  # #define EI_VERSION      6               /* File version byte index */
)
...
PT_LOAD = (
    1  # #define PT_LOAD         1               /* Loadable program segment */
)
PT_NOTE = (
    4  # #define PT_NOTE         4               /* Auxiliary information */
)
...
NT_PRSTATUS = (
    1  # #define NT_PRSTATUS  1  /* Contains copy of prstatus struct */
)
NT_FPREGSET = (
    2  # #define NT_FPREGSET  2  /* Contains copy of fpregset struct */
)
NT_PRPSINFO = (
    3  # #define NT_PRPSINFO  3  /* Contains copy of prpsinfo struct */
)
...
NT_X86_XSTATE = (
    0x202  # #define NT_X86_XSTATE  0x202  /* x86 extended state using xsave */
)
...
class user_pt_regs_struct(
    ctypes.Structure
):  # struct user_regs_struct for AArch64
    _fields_ = [
        ("x0", ctypes.c_ulonglong),  # __u64 regs[31];
        ...
        ("x7", ctypes.c_ulonglong),
        ("x8", ctypes.c_ulonglong),
        ("x9", ctypes.c_ulonglong),
        ("x10", ctypes.c_ulonglong),
        ("x11", ctypes.c_ulonglong),
        ("x12", ctypes.c_ulonglong),
        ("x13", ctypes.c_ulonglong),
        ("x14", ctypes.c_ulonglong),
        ("x15", ctypes.c_ulonglong),
        ("x16", ctypes.c_ulonglong),
        ("x17", ctypes.c_ulonglong),
        ("x18", ctypes.c_ulonglong),
        ("x19", ctypes.c_ulonglong),
        ("x20", ctypes.c_ulonglong),
        ("x21", ctypes.c_ulonglong),
        ("x22", ctypes.c_ulonglong),
        ("x23", ctypes.c_ulonglong),
        ("x24", ctypes.c_ulonglong),
        ("x25", ctypes.c_ulonglong),
        ("x26", ctypes.c_ulonglong),
        ("x27", ctypes.c_ulonglong),
        ("x28", ctypes.c_ulonglong),
        ("x29", ctypes.c_ulonglong),
        ("x30", ctypes.c_ulonglong),
