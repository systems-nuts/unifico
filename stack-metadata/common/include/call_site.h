...
typedef struct __attribute__((__packed__)) call_site {
    ...
    uint64_t unwind_offset; /* beginning of unwinding info records in unwind
                               info section */
    uint16_t num_live;      /* number of live values at site */
    uint64_t live_offset;   /* beginning of live value location records in live
                               value section */
    uint16_t num_arch_live; /* number of arch-specific live values at site */
    uint64_t arch_live_offset; /* beginning of arch-specific live value records
                                  in section */
